...
var searchText = prompt('Ingresá una palabra para buscar en el texto, con o sin mayúsculas')

if (text.indexOf(searchText) !== -1) {
   console.log('La palabra '+ searchText + ' se encuentra en la posicion ' + text.indexOf(searchText)
   )
 } else {
